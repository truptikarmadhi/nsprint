...
var Parts = /*#__PURE__*/function () {
  ...
  parts_createClass(Parts, [{
    ...
    key: "ImageSlider",
    value: function ImageSlider() {
      $('.slider').slick({
        infinite: true,
        speed: 4000,
        // Duration of one full scroll (in ms)
        autoplay: true,
        autoplaySpeed: 0,
        // Delay between scrolls (0 for continuous)
        cssEase: 'linear',
        arrows: false,
        slidesToShow: 2,
        slidesToScroll: 1,
...
;// CONCATENATED MODULE: ./src/js/parts/gsap-animation.js
function gsap_animation_typeof(obj) { "@babel/helpers - typeof"; return gsap_animation_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, gsap_animation_typeof(obj); }
function gsap_animation_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function gsap_animation_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, gsap_animation_toPropertyKey(descriptor.key), descriptor); } }
function gsap_animation_createClass(Constructor, protoProps, staticProps) { if (protoProps) gsap_animation_defineProperties(Constructor.prototype, protoProps); if (staticProps) gsap_animation_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function gsap_animation_toPropertyKey(arg) { var key = gsap_animation_toPrimitive(arg, "string"); return gsap_animation_typeof(key) === "symbol" ? key : String(key); }
function gsap_animation_toPrimitive(input, hint) { if (gsap_animation_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (gsap_animation_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var GsapAnimation = /*#__PURE__*/function () {
  function GsapAnimation() {
    gsap_animation_classCallCheck(this, GsapAnimation);
  }
  gsap_animation_createClass(GsapAnimation, [{
    key: "init",
    value: function init() {
      this.ServiceCards();
      this.Tabs();
    ...
    key: "ServiceCards",
    value: function ServiceCards() {
      $(document).ready(function () {
        console.clear();
        gsap.registerPlugin(ScrollTrigger, ScrollToPlugin);
        $('.service-cards').each(function (sectionIndex) {
          var $section = $(this);
          var $cards = $section.find('.service-card');
          $cards.each(function (i) {
            ...
            ScrollTrigger.create({
              ...
              pin: true,
              pinSpacing: false,
              id: "section".concat(sectionIndex, "-card").concat(i),
              markers: false
            });
          });
        });
