...
var Parts = /*#__PURE__*/function () {
  ...
  parts_createClass(Parts, [{
    ...
    value: function ScrollContent() {
      ...
      var container = document.querySelector(".our-work");
      var list = document.querySelector(".carousel__nav");
      var listItems = gsapWithCSS.utils.toArray(".carousel__nav__item", list);
      var slides = gsapWithCSS.utils.toArray(".carousel__item");
      var tl = gsapWithCSS.timeline();
      var myST = ScrollTrigger.create({
        animation: tl,
        id: "st",
        trigger: container,
        start: "top top",
      ...
      listItems.forEach(function (item, i) {
        item.addEventListener("click", function (e) {
          e.preventDefault();
          var percent = tl.labels[e.target.getAttribute("data-target")] / tl.totalDuration();
        ...
        var previousItem = listItems[i - 1];
        if (previousItem) {
          tl.to(item, {
            background: "#ed3c3c",
